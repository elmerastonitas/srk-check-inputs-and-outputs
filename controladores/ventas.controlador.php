...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($_POST["listaProductos"] == ""){
				...
				swal({
					  type: "error",
					  title: "El registro no se guardado si no hay equipos",
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			/*=============================================
			GUARDAR CAMBIOS DE LA REGISTRO
			=============================================*/	
	...
	static public function ctrEliminarVenta(){
		...
		if(isset($_GET["idVenta"])){
			...
			/*=============================================
			ACTUALIZAR FECHA ÚLTIMA REGISTRO
			=============================================*/
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>COLABORADOR</td>
					<td style='font-weight:bold; border:1px solid #eee;'>USUARIO</td>
					<td style='font-weight:bold; border:1px solid #eee;'>CANTIDAD</td>
					<td style='font-weight:bold; border:1px solid #eee;'>EQUIPOS</td>
					<td style='font-weight:bold; border:1px solid #eee;'>GUÍA REMISIÓN</td	
